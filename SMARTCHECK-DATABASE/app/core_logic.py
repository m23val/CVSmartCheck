...
# ==============================================================================
# === ESTE ARCHIVO ES EL "MOTOR" DE LA APLICACIÓN.                          ===
# === CONTIENE TODA LA LÓGICA DE ANÁLISIS, PERO NO EL CÓDIGO DEL SERVIDOR WEB.===
# ==============================================================================
...
def calcular_puntuacion_base(criterios_cumplidos, criterios_total, max_puntos):
    ...
    if porcentaje < 0.3:
        factor = (porcentaje / 0.3) * 0.2
    elif porcentaje < 0.7:
        factor = 0.2 + ((porcentaje - 0.3) / 0.4) * 0.4
    else:
        factor = 0.6 + ((porcentaje - 0.7) / 0.3) * 0.4
...
class CVRecommendationGenerator:
    ...
    """
    def __init__(self):
        # Tu diccionario gigante 'conocimiento_puesto' completo
        self.conocimiento_puesto = {
            "Desarrollador Full Stack": {
                "tecnologías_clave": ["full stack", "React", "Next.js", "TypeScript", "Node.js", "Express", "Python", "Django", "FastAPI", "MongoDB", "PostgreSQL", "Redis", "Docker", "Kubernetes", "GraphQL", "REST", "AWS", "Azure", "GCP", "CI/CD", "GitHub Actions", "Testing", "Jest", "React Testing Library", "Cypress"],
                "habilidades_técnicas": ["arquitectura de microservicios", "desarrollo web progresivo", "aplicaciones serverless", "optimización de rendimiento", "SEO técnico", "desarrollo dirigido por pruebas (TDD)", "integración continua", "despliegue continuo", "DevOps", "seguridad web"],
                "habilidades_blandas": ["resolución de problemas complejos", "comunicación técnica", "gestión del tiempo", "trabajo en equipo ágil", "mentoría", "capacidad de aprendizaje continuo", "adaptabilidad tecnológica"],
                "certificaciones_valoradas": ["AWS Developer Associate", "Azure Developer Associate", "MongoDB Developer", "Professional Scrum Developer", "Docker Certified Associate", "Kubernetes Developer"],
                "tendencias_2025": ["Web Components", "WebAssembly", "Edge Computing", "Jamstack", "Optimización para Core Web Vitals", "Zero Trust Security", "API-first design", "Desarrollo Headless", "MACH Architecture"]
            },
            "Ingeniero DevOps": {
                "tecnologías_clave": ["Kubernetes", "Docker", "Terraform", "Ansible", "Jenkins", "GitHub Actions", "CircleCI", "ArgoCD", "Prometheus", "Grafana", "ELK Stack", "AWS", "Azure", "GCP", "Linux", "Bash", "Python", "Go", "Istio", "Vault", "Linkerd", "GitOps"],
                "habilidades_técnicas": ["infraestructura como código (IaC)", "automatización de procesos", "seguridad DevSecOps", "observabilidad", "arquitectura de nube", "escalabilidad", "optimización de costos en la nube", "service mesh", "zero-downtime deployments", "gestión de secretos"],
                "habilidades_blandas": ["pensamiento sistémico", "resolución de problemas complejos", "comunicación entre equipos", "gestión de incidentes", "mentoría", "documentación técnica", "comunicación de riesgos"],
                "certificaciones_valoradas": ["Certified Kubernetes Administrator (CKA)", "AWS DevOps Engineer Professional", "Azure DevOps Engineer Expert", "HashiCorp Terraform Associate", "Red Hat Certified Engineer (RHCE)", "Site Reliability Engineering (SRE) certification", "GitOps Certification"],
                "tendencias_2025": ["Platform Engineering", "FinOps", "DevSecOps integrado", "Shift-Left Security", "Infraestructura Inmutable", "GitOps", "ML-enabled Operations", "Zero Trust Security", "Internal Developer Platforms", "Cloud Cost Optimization"]
            },
            "Especialista en Ciberseguridad": {
                "tecnologías_clave": ["Pentest", "SIEM", "SOAR", "EDR", "XDR", "Kali Linux", "Metasploit", "Nmap", "Wireshark", "OWASP ZAP", "Burp Suite", "Splunk", "QRadar", "Snort", "Falco", "Crowdstrike", "Firebase", "Zero Trust", "IAM", "HashiCorp Vault", "AWS Security Hub", "Azure Sentinel"],
                "habilidades_técnicas": ["ethical hacking", "análisis forense digital", "análisis de malware", "threat hunting", "gestión de vulnerabilidades", "arquitecturas Zero Trust", "seguridad en la nube", "seguridad de contenedores", "respuesta a incidentes", "análisis de riesgos"],
                "habilidades_blandas": ["pensamiento analítico", "razonamiento crítico", "comunicación clara de riesgos", "trabajo bajo presión", "atención al detalle", "ética profesional", "aprendizaje continuo", "colaboración interdepartamental"],
                "certificaciones_valoradas": ["CISSP", "CEH", "OSCP", "GIAC", "CompTIA Security+", "AWS Security Specialty", "Certified Cloud Security Professional (CCSP)", "CISM", "CRISC", "eLearnSecurity"],
                "tendencias_2025": ["Seguridad en Entornos Sin Perímetro", "AI/ML para Detección de Amenazas", "Threat Intelligence", "Seguridad en Entornos Cuánticos", "Ciberseguridad para Remote Work", "Supply Chain Security", "API Security", "Seguridad para IoT Industrial", "SASE", "Cloud Security Posture Management"]
            },
            "Ingeniero de Datos": {
                "tecnologías_clave": ["Apache Spark", "Kafka", "Airflow", "dbt", "Snowflake", "Databricks", "AWS Glue", "Delta Lake", "Google BigQuery", "Amazon Redshift", "Azure Synapse", "Hadoop", "Hive", "Python", "SQL", "NoSQL", "Terraform", "Docker", "Kubernetes", "Iceberg", "Trino"],
                "habilidades_técnicas": ["modelado de datos", "ETL/ELT", "data warehousing", "data lakes", "data lakehouse", "streaming data", "batch processing", "data governance", "data quality", "data lineage", "data catalogs", "optimización de queries", "distributed computing"],
                "habilidades_blandas": ["pensamiento analítico", "comunicación interdepartamental", "traducción de necesidades de negocio", "gestión de expectativas", "documentación", "colaboración con equipos de analítica"],
                "certificaciones_valoradas": ["AWS Data Analytics Specialty", "Azure Data Engineer Associate", "Google Professional Data Engineer", "Databricks Certified Data Engineer", "Snowflake SnowPro Core", "Confluent Kafka Developer", "dbt Certified Developer"],
                "tendencias_2025": ["Data Mesh", "Lakehouse Architecture", "Real-time Data Platforms", "Data Contracts", "Data Observability", "Data Privacy Engineering", "Metric Stores", "Feature Stores", "DataOps", "Semantic Layer", "Data Lineage"]
            },
            "Científico de Datos / Machine Learning Engineer": {
                "tecnologías_clave": ["Python", "R", "SQL", "PyTorch", "TensorFlow", "Keras", "Scikit-learn", "Pandas", "NumPy", "Matplotlib", "Hugging Face", "MLflow", "Kubeflow", "DVC", "Databricks", "Weights & Biases", "DVC", "JAX", "ONNX", "Ray", "FastAPI", "Luigi"],
                "habilidades_técnicas": ["deep learning", "NLP", "computer vision", "reinforcement learning", "MLOps", "feature engineering", "análisis estadístico", "modelado predictivo", "series temporales", "optimización de hiperparámetros", "interpretabilidad de modelos", "ML monitoring"],
                "habilidades_blandas": ["pensamiento crítico", "comunicación de resultados complejos", "visualización de datos", "storytelling con datos", "colaboración interdisciplinaria", "ética en IA", "traducción de problemas de negocio", "presentaciones ejecutivas"],
                "certificaciones_valoradas": ["AWS Machine Learning Specialty", "TensorFlow Developer Certificate", "Microsoft Azure AI Engineer", "Google Cloud Professional ML Engineer", "Databricks Certified Machine Learning Professional", "IBM Data Science Professional"],
                "tendencias_2025": ["AutoML", "MLOps", "Responsible AI", "Edge AI", "Few-shot Learning", "Foundation Models", "ML Monitoring", "Feature Stores", "Fairness & Bias Mitigation", "Data-centric AI", "Energy-efficient AI", "Causal ML"]
            },
            "Administrador de Bases de Datos (DBA)": {
                "tecnologías_clave": ["PostgreSQL", "MySQL", "SQL Server", "Oracle Database", "MongoDB", "Cassandra", "Redis", "Elasticsearch", "Neo4j", "Snowflake", "DynamoDB", "Kubernetes", "Docker", "Terraform", "Ansible", "Python", "Bash", "Prometheus", "Grafana"],
                "habilidades_técnicas": ["modelado de datos", "optimización de queries", "tuning de bases de datos", "alta disponibilidad", "disaster recovery", "seguridad de datos", "escalabilidad", "sharding", "replicación", "backups", "monitoreo", "automatización de mantenimiento"],
                "habilidades_blandas": ["resolución de problemas", "comunicación técnica clara", "gestión de crisis", "planificación de capacidad", "trabajo bajo presión", "documentación detallada"],
                "certificaciones_valoradas": ["Oracle Certified Professional", "Microsoft Certified: Azure Database Administrator Associate", "AWS Database Specialty", "MongoDB Professional", "PostgreSQL Associate Certification", "EDB PostgreSQL 12 Associate"],
                "tendencias_2025": ["Autonomous Databases", "Cloud Database Management", "Distributed SQL", "Database DevOps", "Multi-model Databases", "Database-as-a-Service", "Database Observability", "Database Mesh"]
            },
            "Arquitecto de Software": {
                "tecnologías_clave": ["Microservicios", "Serverless", "Kubernetes", "Docker", "Event-driven Architecture", "GraphQL", "REST", "gRPC", "Kafka", "Redis", "AWS", "Azure", "GCP", "Terraform", "Prometheus", "Grafana", "Istio", "Envoy", "Linkerd"],
                "habilidades_técnicas": ["diseño de sistemas distribuidos", "patrones de diseño", "arquitectura limpia", "arquitectura hexagonal", "modelado de dominio", "DDD", "event sourcing", "CQRS", "infraestructura como código", "observabilidad", "resiliencia", "escalabilidad"],
                "habilidades_blandas": ["pensamiento sistémico", "comunicación técnica avanzada", "liderazgo técnico", "mentoría", "gestión de stakeholders", "negociación técnica", "visión estratégica"],
                "certificaciones_valoradas": ["AWS Solutions Architect Professional", "Azure Solutions Architect Expert", "Google Professional Cloud Architect", "TOGAF", "Certified Kubernetes Architect", "Red Hat Certified Architect"],
                "tendencias_2025": ["Composable Architecture", "Microfrontends", "eBPF", "WebAssembly", "Service Mesh", "Edge Computing", "GitOps", "Platform Engineering", "Developer Experience", "Green Software"]
            },
            "Ingeniero de Redes": {
                "tecnologías_clave": ["SD-WAN", "SDN", "Cisco", "Juniper", "Arista", "Palo Alto Networks", "FortiGate", "BGP", "OSPF", "MPLS", "VPN", "IPsec", "SD-LAN", "Terraform", "Ansible", "AWS VPC", "Azure Virtual Network", "GCP VPC", "ZTP", "SASE"],
                "habilidades_técnicas": ["diseño de redes", "configuración de routers y switches", "seguridad perimetral", "detección de intrusos", "monitoreo de redes", "troubleshooting", "automatización de redes", "NAT", "firewalls", "balanceo de carga", "cloud networking"],
                "habilidades_blandas": ["pensamiento analítico", "resolución de problemas", "comunicación técnica clara", "trabajar bajo presión", "documentación detallada", "planificación"],
                "certificaciones_valoradas": ["CCNP", "CCIE", "Juniper JNCIE", "CompTIA Network+", "AWS Advanced Networking Specialty", "Azure Network Engineer Associate", "Certified Network Defender"],
                "tendencias_2025": ["Network Automation", "Network as Code", "Zero Trust Networking", "IBN (Intent-Based Networking)", "NetSecOps", "AI for Network Operations", "SASE", "Network Observability", "5G Private Networks"]
            },
            "Desarrollador de Aplicaciones Móviles": {
                "tecnologías_clave": ["Swift", "Kotlin", "SwiftUI", "Jetpack Compose", "Flutter", "React Native", "Dart", "TypeScript", "GraphQL", "Firebase", "AWS Amplify", "AppSync", "Realm", "Core ML", "ARKit", "TensorFlow Lite", "CI/CD Mobile", "Fastlane"],
                "habilidades_técnicas": ["arquitectura limpia para móvil", "responsive design", "gestión de estado", "optimización de rendimiento", "diseño UX móvil", "patrones de arquitectura móvil", "animaciones", "gestión de memoria", "sincronización offline", "accesibilidad"],
                "habilidades_blandas": ["atención al detalle", "comunicación visual", "empatía con el usuario", "colaboración con diseñadores", "feedback constructivo", "documentación clara"],
                "certificaciones_valoradas": ["Google Associate Android Developer", "App Developer with Swift Certification", "Flutter Developer Certification", "React Native Certification", "AWS Mobile Developer"],
                "tendencias_2025": ["Super Apps", "App Clips/Instant Apps", "AR/VR en móvil", "On-device AI", "Foldable Experiences", "Privacy-first Development", "AppOps", "Sustainable Apps", "Mobile DevSecOps", "Edge Computing"]
            },
            "Ingeniero de Inteligencia Artificial / Deep Learning": {
                "tecnologías_clave": ["PyTorch", "TensorFlow", "JAX", "Hugging Face", "LangChain", "CUDA", "OpenCV", "ONNX", "MLflow", "DVC", "Weights & Biases", "Ray", "Kubeflow", "Prometheus", "Docker", "Kubernetes", "SageMaker", "Vertex AI", "Azure ML"],
                "habilidades_técnicas": ["deep learning", "NLP", "transformers", "RAG", "fine-tuning de LLMs", "computer vision", "MLOps", "reinforcement learning", "GANs", "diffusion models", "redes neuronales", "transfer learning", "distributed training", "data-centric AI", "edge AI"],
                "habilidades_blandas": ["pensamiento crítico", "investigación", "comunicación de conceptos técnicos", "ética en IA", "resolución creativa de problemas", "mantenerse actualizado"],
                "certificaciones_valoradas": ["Deep Learning Specialization (Coursera)", "TensorFlow Developer Certificate", "AWS Machine Learning Specialty", "Google ML Engineer", "NVIDIA DLI", "IBM AI Engineering Professional Certificate"],
                "tendencias_2025": ["Multi-modal AI", "Generative AI Agents", "AI Alignment", "Explainable AI", "Efficient Fine-tuning", "Foundation Models", "AI Reasoning", "Edge AI at Scale", "Green AI", "Vector Databases"]
            },
            "Ingeniero Cloud": {
                "tecnologías_clave": ["AWS", "Azure", "GCP", "Kubernetes", "Terraform", "CloudFormation", "Pulumi", "Docker", "Helm", "Ansible", "GitHub Actions", "Jenkins", "Prometheus", "Grafana", "Istio", "Envoy", "Cilium", "ArgoCD", "Flux"],
                "habilidades_técnicas": ["infraestructura como código", "automatización cloud", "multi-cloud", "cloud-native", "arquitectura serverless", "seguridad en la nube", "optimización de costos", "redes cloud", "observabilidad", "cloud FinOps", "disaster recovery"],
                "habilidades_blandas": ["aprendizaje continuo", "pensamiento arquitectónico", "comunicación interdepartamental", "gestión de costos", "documentación", "trabajo en equipo remoto"],
                "certificaciones_valoradas": ["AWS Solutions Architect", "Azure Administrator", "Google Cloud Architect", "Certified Kubernetes Administrator", "HashiCorp Terraform Associate", "Cloud Security Alliance CCSK"],
                "tendencias_2025": ["FinOps", "Multi-cloud Management", "Cloud Developer Platforms", "Hybrid Cloud", "Edge Cloud", "GitOps", "Infrastructure as Code 2.0", "Policy as Code", "Cloud Native Security"]
            },
            "Ingeniero de Pruebas Automatizadas": {
                "tecnologías_clave": ["Selenium", "Cypress", "Playwright", "Jest", "Pytest", "JUnit", "TestNG", "Appium", "Postman", "REST Assured", "Gatling", "JMeter", "K6", "Cucumber", "BDD", "Docker", "Jenkins", "GitHub Actions", "TestRail", "Jira"],
                "habilidades_técnicas": ["shift-left testing", "TDD", "BDD", "pruebas de regresión", "pruebas de integración", "pruebas de API", "pruebas de rendimiento", "pruebas de seguridad", "automatización continua", "pruebas en la nube", "pruebas paralelas", "pruebas en microservicios"],
                "habilidades_blandas": ["atención al detalle", "pensamiento crítico", "comunicación de errores", "mejora continua", "perspectiva de usuario", "trabajo multidisciplinar"],
                "certificaciones_valoradas": ["ISTQB", "Certified Selenium Professional", "AWS Certified Developer", "Azure DevOps Engineer Expert", "Appium Mobile Tester", "ASTQB Mobile Tester"],
                "tendencias_2025": ["AI-assisted Testing", "Testing as Code", "No-code Test Automation", "Visual Testing", "Chaos Engineering", "Contract Testing", "Quality Engineering", "Shift-Right Testing", "Test Environment as a Service", "Testing in Production"]
            },
            "Consultor en Arquitectura Cloud": {
                "tecnologías_clave": ["AWS", "Azure", "GCP", "Multi-cloud", "Terraform", "CloudFormation", "Kubernetes", "Docker", "Serverless", "Event-driven", "Microservicios", "Service Mesh", "API Gateway", "Zero Trust", "SASE", "Grafana", "DataDog"],
                "habilidades_técnicas": ["arquitectura de soluciones", "diseño de sistemas distribuidos", "migración a la nube", "optimización de costos", "análisis comparativo cloud", "seguridad cloud", "escalabilidad", "alta disponibilidad", "disaster recovery", "well-architected framework"],
                "habilidades_blandas": ["comunicación ejecutiva", "gestión de stakeholders", "pensamiento estratégico", "negociación", "presentaciones efectivas", "orientación al cliente", "empatía"],
                "certificaciones_valoradas": ["AWS Solutions Architect Professional", "Azure Solutions Architect Expert", "Google Professional Cloud Architect", "TOGAF", "Certified Cloud Security Professional", "Cloud Native Computing Foundation CNCF"],
                "tendencias_2025": ["FinOps", "Cloud Center of Excellence", "Cloud Security Posture", "Cloud Governance", "Multi-cloud Strategy", "Sustainability in Cloud", "Edge Cloud", "Sovereign Cloud"]
            },
            "Administrador de Sistemas Linux/Unix": {
                "tecnologías_clave": ["Linux (RHEL, Ubuntu, Debian)", "Bash", "Python", "Ansible", "Terraform", "Docker", "Kubernetes", "Podman", "Prometheus", "Grafana", "ELK Stack", "AWS EC2", "Azure VMs", "Git", "SystemD", "LDAP", "SELinux", "firewalld"],
                "habilidades_técnicas": ["administración de servidores", "automatización de infraestructura", "seguridad de sistemas", "gestión de parches", "networking", "almacenamiento", "backup & restore", "performance tuning", "troubleshooting", "monitoring", "logging", "IAM"],
                "habilidades_blandas": ["resolución de problemas", "comunicación técnica", "trabajo bajo presión", "documentación detallada", "disponibilidad", "gestión de prioridades"],
                "certificaciones_valoradas": ["Red Hat Certified Engineer (RHCE)", "Red Hat Certified System Administrator (RHCSA)", "Linux Foundation Certified Engineer", "CompTIA Linux+", "AWS SysOps Administrator", "Azure Administrator Associate"],
                "tendencias_2025": ["Automatización de sistemas", "Configuración como código", "SRE", "GitOps", "Container-native Linux", "Observabilidad", "Linux Security Modules", "Immutable Infrastructure", "AIops"]
            },
            "Especialista en Blockchain": {
                "tecnologías_clave": ["Ethereum", "Solidity", "Rust", "Polkadot", "Binance Smart Chain", "Solana", "NEAR", "Web3.js", "Ethers.js", "Hardhat", "Truffle", "Ganache", "IPFS", "Chainlink", "OpenZeppelin", "MetaMask", "The Graph", "ZK-Rollups", "Optimistic Rollups"],
                "habilidades_técnicas": ["desarrollo de smart contracts", "tokenomics", "DeFi", "seguridad blockchain", "auditoría de contratos", "arquitectura de dApps", "L2 scaling", "interoperabilidad blockchain", "cryptography", "consensus mechanisms", "NFTs", "zero-knowledge proofs"],
                "habilidades_blandas": ["pensamiento innovador", "investigación", "explicación de conceptos complejos", "pensamiento crítico", "aprendizaje continuo", "comunidad open source"],
                "certificaciones_valoradas": ["Certified Blockchain Developer", "Certified Ethereum Developer", "Blockchain Council Certification", "Consensys Academy Bootcamp", "Certificate in Applied Cryptography", "Web3 Foundation Certification"],
                "tendencias_2025": ["ZK-Rollups", "Sustainable Blockchain", "Interoperabilidad Web3", "Blockchain for Enterprises", "DeFi 2.0", "Real-world Asset Tokenization", "Cross-chain Security", "Identity Solutions", "Blockchain Privacy Solutions"]
            },
            "Ingeniero de Automatización": {
                "tecnologías_clave": ["Python", "Bash", "Ansible", "Terraform", "Puppet", "Chef", "Jenkins", "GitLab CI", "GitHub Actions", "Circle CI", "Docker", "Kubernetes", "Robot Framework", "Selenium", "AWS CDK", "Pulumi", "PowerShell", "UiPath", "Blue Prism"],
                "habilidades_técnicas": ["infraestructura como código", "CI/CD", "DevOps", "scripting", "RPA", "testing automatizado", "monitoreo automático", "flujos de trabajo automatizados", "gestión de configuración", "orchestration", "event-driven automation", "self-healing systems"],
                "habilidades_blandas": ["pensamiento lógico", "resolución de problemas", "documentación detallada", "análisis de procesos", "comunicación interdepartamental", "mejora continua"],
                "certificaciones_valoradas": ["Red Hat Certified Specialist in Ansible Automation", "AWS Developer Associate", "Puppet Professional", "UiPath Certified Professional", "HashiCorp Terraform Associate", "GitLab Professional"],
                "tendencias_2025": ["NoCode/LowCode Automation", "GitOps", "Serverless Automation", "AI-augmented Automation", "Event-driven Automation", "Self-service Automation", "Hyper-automation", "Cross-platform Automation"]
            },
            "Desarrollador Front-End": {
                "tecnologías_clave": ["React", "Next.js", "Vue", "Nuxt", "Angular", "Svelte", "TypeScript", "JavaScript", "TailwindCSS", "Styled Components", "GraphQL", "REST", "Redux", "Zustand", "React Query", "Testing Library", "Cypress", "Storybook", "Webpack", "Vite"],
                "habilidades_técnicas": ["optimización de rendimiento", "responsive design", "accesibilidad (WCAG)", "arquitectura de front-end", "SSR/SSG", "PWA", "microfrontends", "web vitals", "interacción API", "state management", "web animations", "SEO técnico"],
                "habilidades_blandas": ["atención al detalle", "colaboración con diseñadores", "empatía con usuarios", "resolución creativa de problemas", "comunicación visual", "trabajo en equipo"],
                "certificaciones_valoradas": ["Meta Front-End Developer Professional Certificate", "Google UX Design Professional Certificate", "W3Schools Front End Certification", "freeCodeCamp Certification", "JavaScript Certification", "OpenJS Foundation Certification"],
                "tendencias_2025": ["Web Components", "Edge rendering", "WebAssembly", "JAMstack", "Core Web Vitals", "Headless CMS", "Design Systems", "Island Architecture", "Partial Hydration", "Streaming Server Components"]
            },
            "Ingeniero de Integración / API": {
                "tecnologías_clave": ["REST", "GraphQL", "gRPC", "WebSockets", "Apache Kafka", "RabbitMQ", "Apigee", "Kong", "Tyk", "AWS API Gateway", "Azure API Management", "Postman", "Swagger/OpenAPI", "Mulesoft", "Apache Camel", "Zapier", "Terraform", "Kubernetes"],
                "habilidades_técnicas": ["diseño de APIs", "middleware", "ESB", "patrones de integración", "protocols (HTTP, MQTT, AMQP)", "API management", "API testing", "API security", "API documentation", "webhooks", "streaming de datos", "batch processing", "EAI"],
                "habilidades_blandas": ["comunicación interdepartamental", "documentación técnica", "solución de problemas", "pensamiento sistémico", "gestión de stakeholders", "negociación"],
                "certificaciones_valoradas": ["MuleSoft Certified Developer", "Kong Certified Developer", "AWS API Gateway", "Microsoft Azure API Management", "Apigee API Engineer", "Postman API Certification"],
                "tendencias_2025": ["API-first Design", "API Governance", "API Federation", "GraphQL Federation", "Event-driven APIs", "API Analytics", "Zero Trust API", "API SBOM", "Declarative API Systems", "MACH Architecture"]
            },
            "Ingeniero de Big Data": {
                "tecnologías_clave": ["Spark", "Hadoop", "Hive", "Kafka", "Flink", "AWS EMR", "Databricks", "Snowflake", "Redshift", "BigQuery", "Delta Lake", "dbt", "Airflow", "NiFi", "Kubernetes", "Docker", "Python", "Scala", "SQL", "HBase", "Presto", "Trino"],
                "habilidades_técnicas": ["ingeniería de datos distribuidos", "procesamiento batch/streaming", "data lakehouse", "ETL/ELT", "modelado dimensional", "optimización de consultas", "data governance", "data quality", "particionamiento de datos", "escalabilidad", "ingeniería de features"],
                "habilidades_blandas": ["pensamiento analítico", "resolución de problemas complejos", "documentación técnica", "comunicación interdepartamental", "trabajo con stakeholders", "capacidad de abstracción"],
                "certificaciones_valoradas": ["AWS Data Analytics Specialty", "Cloudera Certified Professional", "Databricks Certified Data Engineer", "Google Professional Data Engineer", "Microsoft Certified: Azure Data Engineer", "Snowflake SnowPro Core"],
                "tendencias_2025": ["Data Mesh", "Data Contracts", "Real-time Analytics", "Streaming-first Architecture", "Lakehouse", "Metric Layers", "Feature Stores", "Data Products", "Federated Governance"]
            },
            "Ingeniero IoT": {
                "tecnologías_clave": ["Arduino", "Raspberry Pi", "ESP32", "MQTT", "CoAP", "LoRaWAN", "Zigbee", "BLE", "AWS IoT", "Azure IoT", "Google Cloud IoT", "Node-RED", "TensorFlow Lite", "EdgeX Foundry", "Mosquitto", "Docker", "Kubernetes", "Python", "C/C++"],
                "habilidades_técnicas": ["edge computing", "embedded systems", "conectividad inalámbrica", "seguridad IoT", "protocolos de comunicación", "procesamiento de señales", "analytics en tiempo real", "diseño de PCB", "on-device AI", "computación distribuida", "edge-to-cloud"],
                "habilidades_blandas": ["pensamiento analítico", "resolución de problemas", "pensamiento creativo", "comunicación interdisciplinaria", "atención al detalle", "seguridad by design"],
                "certificaciones_valoradas": ["AWS IoT Specialty", "Microsoft Certified: Azure IoT Developer", "IoT Certified Professional", "Certified IoT Security Practitioner", "Cisco IoT Certification", "CompTIA IoT Practitioner"],
                "tendencias_2025": ["Digital Twins", "IoT + AI/ML", "Edge Intelligence", "5G IoT", "Quantum IoT Security", "Energy Harvesting", "IoT Swarm Intelligence", "IT/OT Convergence", "Advanced Embedded ML"]
            }
        }
        ...
        self.vectorizer = TfidfVectorizer(analyzer='word', ngram_range=(1, 3), stop_words=['de', 'la', 'el', 'en', 'y', 'a', 'con', 'para', 'por', 'del', 'los', 'las', 'un', 'una', 'lo'])

    # Todos tus métodos internos de la clase como _detectar_faltantes, _extraer_tech_stack, etc. van aquí.
    # Por brevedad, se omite el cuerpo de las funciones, pero deben estar presentes en tu código.
...
recommendation_engine = CVRecommendationGenerator()
print("✅ Motor de recomendaciones listo.")

print("✅ Cargando modelo BERT (esto puede tardar un momento)...")
...
try:
    ...
    print(f"❌ Error crítico cargando modelo BERT: {str(e)}")
    tokenizer, model = None, None


# --- Funciones de Utilidad para Procesamiento de Archivos y Texto ---
...
def extraer_texto_pdf(ruta: str) -> str:
    try:
        ...
        raise IOError(f"Error al leer el archivo PDF: {e}")
...
def extraer_texto_docx(ruta: str) -> str:
    try:
        ...
        raise IOError(f"Error al leer el archivo DOCX: {e}")

async def procesar_archivo(archivo: UploadFile) -> str:
    with tempfile.TemporaryDirectory() as temp_dir:
        temp_file_path = Path(temp_dir) / archivo.filename
        try:
            ...
            if temp_file_path.suffix.lower() == '.pdf':
                return extraer_texto_pdf(str(temp_file_path))
            elif temp_file_path.suffix.lower() == '.docx':
                return extraer_texto_docx(str(temp_file_path))
            else:
                raise ValueError("Formato de archivo no soportado")
        except Exception as e:
            raise RuntimeError(f"No se pudo procesar el archivo: {e}")
